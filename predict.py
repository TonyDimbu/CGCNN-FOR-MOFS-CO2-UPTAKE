...
Original file is located at
    https://colab.research.google.com/drive/1PoqS3A6SjlvuYd_u7yDAxc8cfZJ1KT8b
"""
...
class HardcodedArgs:
    modelpath = '/content/drive/MyDrive/model_best.pth (1).tar'  # Replace with the actual path
    cifpath = '/content/drive/MyDrive/root_dir'  # Replace with the actual path
    batch_size = 256
    workers = 0
    disable_cuda = False
    print_freq = 10
    ...
    h_fea_len = 128
    n_h=1
    # Assigning hardcoded values to args
model_args = HardcodedArgs
args = HardcodedArgs
globals()['model_args'] = model_args
